-- ========================================
-- ФИНАЛЬНОЕ ИСПРАВЛЕНИЕ ДУБЛИРУЮЩИХСЯ ФУНКЦИЙ
-- ========================================
...
-- 2. Создаем ЕДИНСТВЕННУЮ версию send_chat_message (с поддержкой file_id)
...
-- 3. Создаем ЕДИНСТВЕННУЮ версию send_chat_message_for_login
...
-- 6. Показываем финальные сигнатуры
SELECT 
