-- Fix citext/text mismatch in get_chat_messages_page return columns.
-- Same signature / access / pagination; cast text-like fields to text.
...
begin
  ...
  with page as (
    select
      ...
      coalesce(m.content::text, m.body::text, '')::text as text,
