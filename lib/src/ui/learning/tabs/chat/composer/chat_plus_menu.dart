          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(action.icon, color: fg),
              ),
                  ...
                  children: [
                    Text(
                      ...
                      style: theme.textTheme.titleSmall?.copyWith(
                        ...
                        color: action.emphasized ? colorScheme.onPrimaryContainer : null,
                      ),
                    ),
              ...
              Icon(Icons.chevron_right, color: fg.withValues(alpha: .7)),
            ],
          ),
        ),
      ),
