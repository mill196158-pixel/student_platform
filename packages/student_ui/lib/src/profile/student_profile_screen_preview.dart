...
/// (and reusable by Mobile later). No Supabase/routing/service imports.
        ...
        Expanded(
          child: OutlinedButton.icon(
            ...
            style: OutlinedButton.styleFrom(
              ...
              backgroundColor: const Color(0xFFEDE7F6).withValues(alpha: 0.55),
            ),
          ),
        ),
        ...
        Expanded(
          child: OutlinedButton.icon(
            ...
            style: OutlinedButton.styleFrom(
              ...
              backgroundColor: const Color(0xFFD6F5EE).withValues(alpha: 0.55),
            ),
          ),
        ),
      ],
