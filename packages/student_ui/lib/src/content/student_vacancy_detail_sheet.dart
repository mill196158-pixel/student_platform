...
class StudentVacancyDetailSheet extends StatefulWidget {
  ...
  final Future<void> Function(VacancyReportReason reason, String? note)? onReport;
            ...
            if (card.hasContacts) ...[
              ...
              if (_contacts == null && !_contactsLoading)
                ...
                OutlinedButton(
                  ...
                  onPressed: widget.onRevealContacts == null
              ...
              children: [
                ...
                if (widget.onReport != null && !widget.showDemoBadge)
                  ...
                  TextButton.icon(
                    ...
                    label: Text(_reportSent ? 'Жалоба отправлена' : 'Пожаловаться'),
